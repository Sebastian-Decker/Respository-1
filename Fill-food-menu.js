...
const populateFood = async function() {
    ...
    $.getJSON("Menu_items.json", function(menuData) {
        // console.dir(menuData.menu[0].items[0]);
        console.dir(menuData);
        const foodMenuElement = document.getElementById("menu"); // step 1: get parent element from document
